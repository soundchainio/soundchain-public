          ...
          <div>
            <div className="flex flex-col bg-black border-2 border-gray-700 rounded m-3 p-4 gap-4">
              ...
              <p className="text-white text-xs">
                With a fixed-price Buy It Now listing, a buyer knows the exact price they need to pay for your NFT and
                can complete their purchase immediately. There is no bidding on fixed-price listings.
              </p>
