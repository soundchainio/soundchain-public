...
export default function WalletPage() {
  ...
  const WalletHeader = ({ children }: WalletHeaderProps) => {
    return (
  ...
  if (selectedWallet === DefaultWallet.MetaMask && !connectedToMetaMask) {
    return (
      <WalletHeader>
  ...
  if (selectedWallet === DefaultWallet.MetaMask && !correctNetwork) {
    return (
      <WalletHeader>
