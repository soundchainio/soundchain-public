...
import { useSendMessageMutation, useResetUnreadMessageCountMutation } from 'hooks/useMutationsDirect'  // Phase 7f — Vercel-direct
...
function PulsePage() {
  ...
  const handleInstallClick = async () => {
    if (deferredPrompt) {
      ...
      try { await navigator.clipboard.writeText('https://soundchain.io/pulse') } catch {}
          ...
          <div className="px-4 pb-4">
            {isIOS ? (
              <div className="space-y-3">
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText('https://soundchain.io/pulse')
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] mt-1 leading-relaxed" style={{ color: WA.text_secondary }}>
                To fix: remove this app from Home Screen, open Safari → soundchain.io/pulse → Add to Home Screen again → tap Allow when prompted.
              </p>
            </div>
            <button
    ...
    <div className="flex flex-col h-full" style={{ backgroundColor: WA.bg }}>
      ...
      <div className="flex items-center justify-between px-3 py-2" style={{ backgroundColor: WA.header, paddingTop: 'max(0.5rem, env(safe-area-inset-top, 0.5rem))' }}>
        <div className="flex items-center gap-2">
          ...
          <Link href="/nodes" className="flex items-center p-1 rounded-lg hover:bg-white/10 transition-colors">
            <MiniSphere size={28} />
          </Link>
