      ...
      <div className="min-h-screen bg-black text-white pb-20">
        ...
        <div className="border-b border-cyan-500/20 bg-gradient-to-b from-cyan-500/5 to-transparent">
          <div className="max-w-6xl mx-auto px-4 py-8">
            <Link href="/nodes" className="inline-flex items-center gap-2 text-gray-400 hover:text-cyan-400 text-sm mb-6 transition">
          ...
          <div className="bg-gradient-to-br from-gray-900/60 to-black border border-cyan-500/20 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-300">
              ...
              <div>
                ...
                <p className="text-gray-400">Go to any <Link href="/nodes" className="text-cyan-400 hover:underline">/dex</Link> page. FURL lives at the top — it&apos;s always there.</p>
              </div>
              <div>
