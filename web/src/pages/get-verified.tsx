...
import { ProfileVerificationRequest, useCreateProfileVerificationRequestMutation, useProfileVerificationRequestQuery, useRemoveProfileVerificationRequestMutation } from 'lib/graphql';
...
export default function GetVerified() {
  ...
  return (
    <Layout topNavBarProps={topNavBarProps}>
      ...
      {requested?.status === ManageRequestTab.PENDING && <div className="text-gray-400 text-sm px-4 pb-10 text-center">
      ...
      {requested?.status === ManageRequestTab.APPROVED && <div className="text-gray-400 text-sm px-4 pb-10 text-center">
        Your account is legitimate!
      </div>
      }

      {requested?.status === ManageRequestTab.DENIED && <div className="text-gray-400 text-sm px-4 pb-10 text-center">
