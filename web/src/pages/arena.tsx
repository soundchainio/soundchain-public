/**
 * /arena — Console Gaming Arena (Nodeverse)
 *
      ...
      <div className="max-w-[1400px] mx-auto px-4 py-4 space-y-4">
        ...
        >
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            <div className="p-3 rounded-lg bg-green-500/15 border border-green-500/30 self-start">
              <Trophy className="w-6 h-6 text-green-400" />
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                <h2 className="text-base sm:text-lg font-black text-white tracking-tight">🏈 NFL Fantasy Leagues</h2>
            ...
            <div className="flex gap-2 shrink-0">
              <button
                onClick={() => router.push('/arena/fantasy')}
                className="px-3 py-2 bg-green-600 hover:bg-green-500 rounded-lg text-xs font-bold text-white whitespace-nowrap transition"
              >
                Browse Leagues
              </button>
              <button
                onClick={() => router.push('/arena/fantasy?new=1')}
                className="px-3 py-2 bg-black/60 hover:bg-black/80 border border-green-500/40 rounded-lg text-xs font-bold text-green-300 whitespace-nowrap transition flex items-center gap-1"
              >
