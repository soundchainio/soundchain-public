...
import { Play, Pause, Heart, Share2, MoreHorizontal, Clock, X, Trash2 } from 'lucide-react'
import { useAudioPlayerContext, Song } from 'hooks/useAudioPlayer'
import { GetUserPlaylistsQuery, useDeletePlaylistTracksMutation } from 'lib/graphql'
...
export const PlaylistDetail = ({ playlist, onClose, isOwner = false }: PlaylistDetailProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-hidden bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 rounded-2xl border border-pink-500/20 shadow-2xl">
        {/* Close button */}
        <button
          onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="sticky top-0 bg-neutral-900/90 backdrop-blur px-6 py-4 border-b border-neutral-800">
              <div className="flex items-center text-xs text-gray-500 uppercase tracking-wider">
                ...
                <span className="w-24 text-right hidden sm:block">Plays</span>
              ...
              {tracks.length === 0 ? (
                ...
                tracks.map((pt, index) => {
                  ...
                  return (
                    <div
                      key={pt.id}
                      className={`group flex items-center px-4 py-3 rounded-lg hover:bg-neutral-800/50 transition-colors cursor-pointer ${
                    ...
                    >
                      ...
                      {/* Play count */}
                      <div className="w-24 text-right text-gray-500 text-sm hidden sm:block">
