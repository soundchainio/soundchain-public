          ...
          <div className="flex-1 min-w-0 flex flex-col justify-between py-1">
            ...
            <div className="flex items-center gap-2 mb-1">
              {isGuest ? (
                ...
                <Link href={post.profile!.userHandle ? `/profiles/${post.profile!.userHandle}` : '#'} className="flex items-center gap-1.5 hover:opacity-80" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-3 border-t border-white/10 bg-neutral-900">
          <div className="flex items-center justify-between">
            ...
            {isGuest ? (
              ...
              <Link
                href={post.profile!.userHandle ? `/profiles/${post.profile!.userHandle}` : '#'}
