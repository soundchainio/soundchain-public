...
export const Layout = ({ children, hideBottomNavBar, topNavBarProps, fullHeight, className }: LayoutProps) => {
    ...
    <div className="h-full flex-1 flex overflow-hidden">
      ...
      <div className="flex flex-col w-0 flex-1 overflow-hidden">
        ...
        <main id="main" className="flex-1 relative overflow-y-auto focus:outline-none bg-gray-10">
          <div
            className={classNames('max-w-7xl mx-auto', hideBottomNavBar || fullHeight ? 'h-full' : 'mb-20', className)}
          >
            {children}
          </div>
        </main>
