    ...
    <nav className="backdrop-blur-xl bg-gray-900/95 border-b border-cyan-500/20 px-2 sm:px-4 lg:px-6 py-1.5 sm:py-2 sticky top-0 z-50 shadow-lg">
      <div className="flex items-center justify-between max-w-screen-2xl mx-auto">
        ...
        <div className="flex items-center space-x-3">
          <Link href="/dex" className="flex items-center space-x-2 flex-shrink-0">
        ...
        {/* Right: Quick Links */}
        <div className="flex items-center space-x-3">
          <Link href="/dex/feed" className="text-xs text-gray-400 hover:text-cyan-400 transition-colors hidden sm:inline">
            Home
          </Link>
