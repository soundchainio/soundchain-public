  ...
  return (
    <div className="relative w-full mr-4">
      <input
        ...
        className=" border pl-8 border-gray-30 font-bold bg-gray-1A w-full text-gray-200 focus:outline-none focus:ring-transparent placeholder-gray-60 placeholder-semibold text-xs"
      />
