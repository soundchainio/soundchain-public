import { RoadmapFragments } from 'components/pages/roadmap/roadmapStep'
...
export const roadmapSteps: RoadmapStep[] = [
  ...
  },
  {
    ...
    status: '',
    description:
      "We'll be adding decentralized live streaming capabilities as a new way to really connect with your fans. It'll be easy to broadcast and to watch/listen, powered by IPFS and OGUN rewards",
  },
  {
    title: 'DAW',
    status: '',
