...
export default function LucyPill() {
  ...
  // Lucy is furdA1-only during construction. Public rollout will come after
  // the 3-headed-triangle phase (Piper natural voice + WebRTC FaceTime audio
  // + RTX 5000 compute upgrade) — current M5000 + browser TTS quality bar
  // isn't ready for non-Frank users. Case-insensitive for legacy 2021
  // accounts where handle lives on users.handle not profiles.userHandle.
