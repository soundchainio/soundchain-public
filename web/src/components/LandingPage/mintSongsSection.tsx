      ...
      <div className='relative z-10'>
        <SectionWrapper>
          <div className='container mx-auto h-full flex-1 xl:px-40'>
            <div className='relative flex flex-col items-center md:items-start h-full pl-4 py-16 md:pl-6 md:py-24 lg:py-32 lg:pl-8'>
              ...
              <div className='flex flex-col lg:flex-row mt-56'>
                <div className='flex flex-col min-w-[400px]'>
                  ...
                  <div className='text-7xl text-[#77F744] flex flex-row md:flex-col mx-auto md:mx-0'>
                    <span>pol</span>
                    <span>yg</span>
                    <span>on</span>
                  </div>
