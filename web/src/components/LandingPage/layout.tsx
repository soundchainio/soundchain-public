                  ...
                  <div
                    ...
                    <div className='mt-6 w-full text-xl text-indigo-200'>
                      <div className='flex items-center relative isolate group cursor-pointer'>
                        <div
                          className={`absolute -left-4 w-2 group-hover:w-full -translate-y-1
        ...
        <div className='container mx-auto h-full flex-1'>
          <div className='relative flex flex-col items-start h-full pl-4 py-16 sm:pl-6 sm:py-24 lg:py-32 lg:pl-8'>
            <div className='text-center'>
              <span>quickly</span>
              <span>mint songs on the blockchain</span>
            </div>
            <div className='flex mt-20'>
              <div className='flex flex-col'>
                <span>Mint NFTs on</span>
                <div>
                  <span>pol</span>
                  <span>yg</span>
                  <span>on</span>
              ...
              <div className='flex flex-col'>
                ...
                <div className='grid grid-cols-3'>
                  ...
                  <div className='col-span-1'>
                    ...
                    <span>Get full control over how your work is used and where</span>
                  </div>
                  <div className='col-span-1'>
                    <span>your music earns more</span>
                    <span>Blockchain hosting means you get paid directly per stream</span>
                  </div>
                </div>
              </div>
            </div>
...
export default function LandingPageLayout({ children }: LayoutProps) {
  return (
    <div className='relative h-full flex flex-col text-white bg-sky-200'>
      <Section1 />
      <Section2 />
      <Section3 />
      <Section4 />
