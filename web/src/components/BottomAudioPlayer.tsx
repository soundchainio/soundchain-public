    ...
    return (
      <article className="bg-black flex flex-col">
        <div className="flex">
          ...
          <div className="w-full text-xxs leading-3 flex flex-col items-center px-3 pt-[6px] min-w-0">
            <div className='flex flex-col items-center w-full'>
              <h2 className="text-white font-black truncate max-w-full">{currentSong.title || 'Unknown title'}</h2>
              <p className="text-gray-80 font-medium truncate max-w-full">{currentSong.artist || 'Unknown artist'}</p>
            </div>
          ...
          <div className='flex flex-col items-center justify-end flex-2'>
            <div className='flex gap-3 text-white'>
              ...
              <button
                ...
                onClick={playPrevious}
              >
                <Rewind height={10} width={15} className={'hover:fill-current active:text-gray-80'}/>
              </button>
              <button
                ...
                onClick={togglePlay}
              >
                {isPlaying ? <Pause height={10} width={10} fill="black" /> : <Play height={10} width={10} fill="black" />}
              </button>
              <button
                className={`${
                  !hasNext && 'cursor-default'
                ...
                disabled={!hasNext}
              >
                <Forward height={10} width={15} className={`${hasNext && 'hover:fill-current'} active:text-gray-80`} />
              </button>
            ...
            <div className="flex justify-between text-xxs text-gray-80 w-full max-w-xl">
              <p>{timeFromSecs(progress || 0)}</p>
              <p onClick={onPlaybackDurationClick}>
