      ...
      <nav className="backdrop-blur-xl bg-gray-900/95 border-b border-cyan-500/20 px-2 sm:px-4 lg:px-6 py-1.5 sm:py-2 shadow-lg">
        <div className="flex items-center justify-between max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center gap-1 sm:gap-2 lg:gap-3 flex-shrink-0">
            ...
            <Link href="/stake" className="flex-shrink-0" title="PiggyBank — Rewards">
            ...
            {/* Profile Avatar */}
            {me && (
              <Link href={`/profiles/${me.profile.userHandle}`} className="flex-shrink-0 p-0.5 rounded-full hover:bg-white/10 transition" aria-label="Profile">
