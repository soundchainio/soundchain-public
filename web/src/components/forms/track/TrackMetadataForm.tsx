...
function InnerForm(props: InnerFormProps) {
  ...
  // Calculate 0.05% platform fee based on gas cost: fee = 0.0005 × gasCost
  const gasCost = parseFloat(maxMintGasFee || '0')
        ...
        <div className="flex flex-col gap-2 mb-3 p-3 bg-gray-800/50 rounded-lg border border-gray-700">
          ...
          <div className="flex justify-between items-center text-xs">
            <span className="text-gray-400">
              Platform Fee ({(config.soundchainFee * 100).toFixed(2)}% of gas)
            </span>
