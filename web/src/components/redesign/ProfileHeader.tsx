...
// Mock profile images - replace with actual imports when available
const profileAvatar = "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&crop=face";
const backgroundCover = "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=1200&h=400&fit=crop";
            ...
            <div className="flex-1 space-y-4">
              <div className="space-y-2">
                <div className="flex items-center gap-3 flex-wrap">
                  <h1 className="retro-title text-2xl lg:text-3xl">Xamã</h1>
                ...
                <p className="retro-json text-sm">@xama</p>
                <p className="text-gray-300 text-sm lg:text-base max-w-md leading-relaxed">
                  The official SoundChain account of Xamã. Here is an example of what the bio should look like on the profile.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 lg:gap-4">
                <div className="metadata-section p-3 lg:p-4 text-center">
                  <div className="retro-text text-xl lg:text-2xl">25</div>
                  <div className="metadata-label text-xs">Tracks</div>
                </div>
                <div className="metadata-section p-3 lg:p-4 text-center">
                  <div className="retro-text text-xl lg:text-2xl">3,537</div>
                  <div className="metadata-label text-xs">Followers</div>
                </div>
                <div className="metadata-section p-3 lg:p-4 text-center">
                  <div className="retro-text text-xl lg:text-2xl">1,237</div>
              ...
              <Card className="retro-card p-3 w-fit">
                <div className="flex items-center gap-3">
                  ...
                  <span className="retro-json text-sm">0xf30...345</span>
                  <Button variant="ghost" size="sm" className="hover:bg-cyan-500/20 p-1">
