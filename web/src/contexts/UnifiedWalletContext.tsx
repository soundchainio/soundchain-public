...
const chainRpcs: Record<number, string> = {
  ...
  137: (typeof window !== 'undefined' ? window.location.origin + '/api/rpc/polygon' : 'https://soundchain.io/api/rpc/polygon'),
...
const getRpcForChain = (chainId: number): string => chainRpcs[chainId] || (typeof window !== 'undefined' ? window.location.origin + '/api/rpc/polygon' : 'https://soundchain.io/api/rpc/polygon')
