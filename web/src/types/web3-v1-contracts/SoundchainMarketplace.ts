...
export interface SoundchainMarketplace extends BaseContract {
  constructor(jsonInterface: any[], address?: string, options?: ContractOptions): SoundchainMarketplace
  clone(): SoundchainMarketplace
  methods: {
    buyItem(_nftAddress: string, _tokenId: number | string | BN, _owner: string): PayableTransactionObject<void>
