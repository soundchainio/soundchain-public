...
export interface Soundchain721Editions extends BaseContract {
  ...
  events: {
    ...
    ConsecutiveTransfer(options?: EventOptions, cb?: Callback<ConsecutiveTransfer>): EventEmitter
  ...
  once(event: 'ConsecutiveTransfer', options: EventOptions, cb: Callback<ConsecutiveTransfer>): void
