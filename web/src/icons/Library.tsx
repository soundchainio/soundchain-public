export const Library = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg width={20} height={20} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x={1} y={5} width={18} height={14} rx={3} stroke="#505050" strokeWidth={2} />
      <path
        ...
        fill="#505050"
      />
      <rect x={4} y={2} width={12} height={1.5} rx={0.75} fill="#505050" />
      <rect x={6} width={8} height={1.5} rx={0.75} fill="#505050" />
    </svg>
  );
};
