...
export type ImageUploadUrlQuery = { __typename?: 'Query' } & {
  imageUploadUrl: { __typename?: 'ImageUploadUrl' } & Pick<ImageUploadUrl, 'uploadUrl' | 'fileName' | 'readUrl'>;
};
...
export type UpdateProfileBioMutation = { __typename?: 'Mutation' } & {
  updateProfileBio: { __typename?: 'UpdateProfileDisplayNamePayload' } & {
...
export type UploadTrackMutationVariables = Exact<{ [key: string]: never }>;
...
export type UploadTrackMutation = { __typename?: 'Mutation' } & {
  uploadTrack: { __typename?: 'UploadTrackPayload' } & {
    track: { __typename?: 'Track' } & Pick<Track, 'id'> & {
        upload: { __typename?: 'AudioUpload' } & Pick<AudioUpload, 'url'>;
      };
  };
};
 ...
 * });
 */
export function useImageUploadUrlQuery(
  baseOptions: Apollo.QueryHookOptions<ImageUploadUrlQuery, ImageUploadUrlQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ImageUploadUrlQuery, ImageUploadUrlQueryVariables>(ImageUploadUrlDocument, options);
}
export function useImageUploadUrlLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ImageUploadUrlQuery, ImageUploadUrlQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
