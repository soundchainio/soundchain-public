...
export type AddTrackMetadataMutation = { __typename?: 'Mutation' } & {
  addTrackMetadata: { __typename?: 'AddTrackMetadataPayload' } & {
    track: { __typename?: 'Track' } & Pick<Track, 'id' | 'title' | 'description'>;
  };
};
...
export type MeQuery = { __typename?: 'Query' } & {
  me: Maybe<
    { __typename?: 'User' } & Pick<User, 'id' | 'handle' | 'email'> & {
...
export type TrackComponentFieldsFragment = { __typename?: 'Track' } & Pick<
  Track,
  'id' | 'profileId' | 'title' | 'playbackUrl' | 'createdAt' | 'updatedAt'
>;
...
export type UpdatePasswordMutation = { __typename?: 'Mutation' } & {
  updatePassword: { __typename?: 'UpdatePasswordPayload' } & Pick<UpdatePasswordPayload, 'ok'>;
};
...
export type UploadTrackMutation = { __typename?: 'Mutation' } & {
  uploadTrack: { __typename?: 'UploadTrackPayload' } & {
    track: { __typename?: 'Track' } & Pick<Track, 'id' | 'uploadUrl'> & {
        muxUpload: { __typename?: 'MuxUpload' } & Pick<MuxUpload, 'url'>;
      };
  };
};
...
`;
export type AddTrackMetadataMutationFn = Apollo.MutationFunction<
  AddTrackMetadataMutation,
  AddTrackMetadataMutationVariables
>;
 ...
 * });
 */
export function useAddTrackMetadataMutation(
  baseOptions?: Apollo.MutationHookOptions<AddTrackMetadataMutation, AddTrackMetadataMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<AddTrackMetadataMutation, AddTrackMetadataMutationVariables>(
    AddTrackMetadataDocument,
    options,
  );
}
...
export type AddTrackMetadataMutationOptions = Apollo.BaseMutationOptions<
  AddTrackMetadataMutation,
  AddTrackMetadataMutationVariables
>;
...
export function useUploadTrackMutation(
  baseOptions?: Apollo.MutationHookOptions<UploadTrackMutation, UploadTrackMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
