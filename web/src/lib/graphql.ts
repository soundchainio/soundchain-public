...
export type ProfileQuery = (
  ...
  & { profile: (
    { __typename?: 'Profile' }
    & Pick<Profile, 'id' | 'displayName' | 'profilePicture' | 'coverPicture' | 'defaultCoverPicture' | 'userHandle' | 'isFollowed' | 'isSubscriber' | 'followerCount' | 'followingCount' | 'musicianTypes' | 'bio'>
    & { socialMedias: (
      { __typename?: 'SocialMedias' }
