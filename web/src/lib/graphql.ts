  ...
  chats: { __typename?: 'ChatConnection' } & {
    nodes: Array<
      { __typename?: 'Chat' } & Pick<Chat, 'id' | 'message' | 'unread' | 'createdAt'> & {
          profile: { __typename?: 'Profile' } & Pick<Profile, 'displayName' | 'profilePicture'>;
        }
    >;
...
export type CreateListingItemMutation = { __typename?: 'Mutation' } & {
  createListingItem: { __typename?: 'CreateListingItemType' } & Pick<
    CreateListingItemType,
    'owner' | 'nft' | 'tokenId' | 'quantity' | 'pricePerItem' | 'startingTime'
  >;
};
...
export type CreateMintingRequestMutation = { __typename?: 'Mutation' } & {
  createMintingRequest: { __typename?: 'MintingRequestPayload' } & {
    mintingRequest: { __typename?: 'MintingRequest' } & Pick<MintingRequest, 'id' | 'transactionId'>;
  };
};
...
export type CreateTrackMutation = { __typename?: 'Mutation' } & {
  createTrack: { __typename?: 'CreateTrackPayload' } & {
  ...
  followers: { __typename?: 'FollowConnection' } & {
    nodes: Array<
      { __typename?: 'Follow' } & Pick<Follow, 'id'> & {
          followerProfile: { __typename?: 'Profile' } & Pick<Profile, 'id' | 'displayName' | 'profilePicture'>;
        }
    >;
...
export type FollowingQuery = { __typename?: 'Query' } & {
  following: { __typename?: 'FollowConnection' } & {
    nodes: Array<
      { __typename?: 'Follow' } & Pick<Follow, 'id'> & {
          followedProfile: { __typename?: 'Profile' } & Pick<Profile, 'id' | 'displayName' | 'profilePicture'>;
        }
    >;
    pageInfo: { __typename?: 'PageInfo' } & Pick<PageInfo, 'hasNextPage' | 'endCursor' | 'totalCount'>;
  };
...
export type ListingItemQuery = { __typename?: 'Query' } & {
  listingItem: { __typename?: 'CreateListingItemType' } & Pick<
    CreateListingItemType,
    'owner' | 'nft' | 'tokenId' | 'quantity' | 'pricePerItem' | 'startingTime'
  >;
};
...
export type MeQuery = { __typename?: 'Query' } & {
  me: Maybe<
    { __typename?: 'User' } & Pick<
      User,
      'id' | 'handle' | 'email' | 'walletAddress' | 'defaultWallet' | 'isApprovedOnMarketplace'
    > & {
...
export type PostsQuery = { __typename?: 'Query' } & {
  posts: { __typename?: 'PostConnection' } & { nodes: Array<{ __typename?: 'Post' } & PostComponentFieldsFragment> };
};
...
export type ProfileDisplayNameQuery = { __typename?: 'Query' } & {
  profile: { __typename?: 'Profile' } & Pick<Profile, 'displayName'>;
};
...
export type SetIsApprovedOnMarketplaceMutation = { __typename?: 'Mutation' } & {
  setIsApprovedOnMarketplace: { __typename?: 'UpdateHandlePayload' } & {
...
export type SetNotValidMutation = { __typename?: 'Mutation' } & {
  setNotValid: { __typename?: 'CreateListingItemType' } & Pick<
    CreateListingItemType,
    'owner' | 'nft' | 'tokenId' | 'quantity' | 'pricePerItem' | 'startingTime'
  >;
};
...
> & {
    nftData: Maybe<
      { __typename?: 'NFTDataType' } & Pick<
        NftDataType,
        'transactionHash' | 'tokenId' | 'contract' | 'minter' | 'ipfsCid'
      >
    >;
  };
...
export type UpdateHandleMutation = { __typename?: 'Mutation' } & {
  updateHandle: { __typename?: 'UpdateHandlePayload' } & {
    user: { __typename?: 'User' } & Pick<User, 'id' | 'handle'>;
  };
};
...
export type UpdatePostMutation = { __typename?: 'Mutation' } & {
  updatePost: { __typename?: 'UpdatePostPayload' } & { post: { __typename?: 'Post' } & Pick<Post, 'id'> };
};
...
`;
export type CreateListingItemMutationFn = Apollo.MutationFunction<
  CreateListingItemMutation,
  CreateListingItemMutationVariables
>;
 ...
 * });
 */
export function useCreateListingItemMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateListingItemMutation, CreateListingItemMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateListingItemMutation, CreateListingItemMutationVariables>(
    CreateListingItemDocument,
    options,
  );
}
...
export type CreateListingItemMutationOptions = Apollo.BaseMutationOptions<
  CreateListingItemMutation,
  CreateListingItemMutationVariables
>;
...
`;
export type CreateMintingRequestMutationFn = Apollo.MutationFunction<
  CreateMintingRequestMutation,
  CreateMintingRequestMutationVariables
>;
 ...
 * });
 */
export function useCreateMintingRequestMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateMintingRequestMutation, CreateMintingRequestMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateMintingRequestMutation, CreateMintingRequestMutationVariables>(
    CreateMintingRequestDocument,
    options,
  );
}
...
export type CreateMintingRequestMutationOptions = Apollo.BaseMutationOptions<
  CreateMintingRequestMutation,
  CreateMintingRequestMutationVariables
>;
...
export function useProfileDisplayNameQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ProfileDisplayNameQuery, ProfileDisplayNameQueryVariables>(
...
export function useRetractReactionMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<RetractReactionMutation, RetractReactionMutationVariables>(
    RetractReactionDocument,
    options,
  );
}
...
`;
export type SetIsApprovedOnMarketplaceMutationFn = Apollo.MutationFunction<
  SetIsApprovedOnMarketplaceMutation,
  SetIsApprovedOnMarketplaceMutationVariables
>;
 ...
 * });
 */
export function useSetIsApprovedOnMarketplaceMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<SetIsApprovedOnMarketplaceMutation, SetIsApprovedOnMarketplaceMutationVariables>(
    SetIsApprovedOnMarketplaceDocument,
    options,
  );
}
...
export type SetIsApprovedOnMarketplaceMutationOptions = Apollo.BaseMutationOptions<
  SetIsApprovedOnMarketplaceMutation,
  SetIsApprovedOnMarketplaceMutationVariables
>;
 ...
 * });
 */
export function useSetNotValidMutation(
  baseOptions?: Apollo.MutationHookOptions<SetNotValidMutation, SetNotValidMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useUnreadMessageCountQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UnreadMessageCountQuery, UnreadMessageCountQueryVariables>(
