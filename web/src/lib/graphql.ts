...
export type NewerCommentsQuery = { __typename?: 'Query' } & {
  comments: { __typename?: 'CommentConnection' } & {
    nodes: Array<{ __typename?: 'Comment' } & CommentComponentFieldsFragment>;
    pageInfo: { __typename?: 'PageInfo' } & Pick<PageInfo, 'hasPreviousPage' | 'startCursor'>;
  };
};
...
export type OlderCommentsQuery = { __typename?: 'Query' } & {
  comments: { __typename?: 'CommentConnection' } & {
    nodes: Array<{ __typename?: 'Comment' } & CommentComponentFieldsFragment>;
    pageInfo: { __typename?: 'PageInfo' } & Pick<PageInfo, 'hasPreviousPage' | 'hasNextPage' | 'endCursor'>;
  };
};
...
export type UpdateMusicianTypeMutation = { __typename?: 'Mutation' } & {
  updateMusicianType: { __typename?: 'UpdateFavoriteGenresPayload' } & {
    profile: { __typename?: 'Profile' } & Pick<Profile, 'id' | 'musicianType'>;
  };
};
...
export type UpdateProfileDisplayNameMutation = { __typename?: 'Mutation' } & {
  updateProfileDisplayName: { __typename?: 'UpdateProfileDisplayNamePayload' } & {
 ...
 * });
 */
export function useNewerCommentsQuery(
  baseOptions: Apollo.QueryHookOptions<NewerCommentsQuery, NewerCommentsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<NewerCommentsQuery, NewerCommentsQueryVariables>(NewerCommentsDocument, options);
}
export function useNewerCommentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<NewerCommentsQuery, NewerCommentsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useOlderCommentsQuery(
  baseOptions: Apollo.QueryHookOptions<OlderCommentsQuery, OlderCommentsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<OlderCommentsQuery, OlderCommentsQueryVariables>(OlderCommentsDocument, options);
}
export function useOlderCommentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<OlderCommentsQuery, OlderCommentsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
