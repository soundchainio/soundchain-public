...
export type ClearNotificationsMutation = { __typename?: 'Mutation' } & {
  clearNotifications: { __typename?: 'ClearNotificationsPayload' } & Pick<ClearNotificationsPayload, 'success'>;
};
...
export type CommentNotificationFieldsFragment = { __typename?: 'CommentNotification' } & Pick<
  CommentNotification,
  'id' | 'type' | 'body' | 'previewBody' | 'link' | 'createdAt' | 'author' | 'authorPicture'
>;
...
export type NotificationQuery = { __typename?: 'Query' } & {
  notification: { __typename?: 'CommentNotification' } & CommentNotificationFieldsFragment;
};
...
export type NotificationsQuery = { __typename?: 'Query' } & {
  notifications: { __typename?: 'NotificationConnection' } & {
    nodes: Array<{ __typename?: 'CommentNotification' } & CommentNotificationFieldsFragment>;
  };
};
