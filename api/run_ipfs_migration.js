...
async function migrate() {
  const uri = process.env.DATABASE_URL || 'mongodb://localhost:27018/soundchain?tls=true&tlsAllowInvalidCertificates=true&retryWrites=false&directConnection=true';
