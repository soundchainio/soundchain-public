...
export class MailchimpService extends Service {
  ...
  constructor(context: Context) {
    ...
    // Mailchimp decommissioned Feb 2026
    ...
    this.transactionalClient = config.mailchimp.transactionalApiKey
      ? mailchimpTransactional(config.mailchimp.transactionalApiKey)
      : (null as any);
  }
